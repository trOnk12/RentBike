...
@Inject constructor() : RecyclerView.Adapter<BikeStationsAdapter.ViewHolder>() {
    ...
    internal var bikeStationClickListener: (BikeStationItem) -> Unit = { _ -> }

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder =
        ViewHolder(parent.inflate(R.layout.bike_station_item))
    ...
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        fun bind(bikeStationItem: BikeStationItem, bikeStationClickListener: (BikeStationItem) -> Unit) {
